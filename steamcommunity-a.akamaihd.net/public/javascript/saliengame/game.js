...
CPlanetSelectionState.prototype._RefreshInfoBoxGames = function()
{
	...
	for(var idx = 0; idx < this.m_GameBannerIds.length; idx++ )
	{
		...
		sprite.pointertap = function() {
			window.open( 'store.steampowered.com/app/'+appId + '/?snr=1_saliens_4__salienapps', '_blank' );
		};
		box.addChild(sprite);
...
{
	var instance = this;
	LoadAsset( 'attack_config', 'steamcdn-a.akamaihd.net/steamcommunity/public/assets//saliengame/attacks.json', '7' );
	LoadAsset( 'enemy_config', 'steamcdn-a.akamaihd.net/steamcommunity/public/assets//saliengame/enemies.json', '7' );
	LoadAsset( 'level_config', 'steamcdn-a.akamaihd.net/steamcommunity/public/assets//saliengame/levels.json', '9' );
